...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, _1_ManualComponent, _2_ManualSeparate, Angular3GCComponent, Angular4DataBindingComponent, Angular5P2cDsParentComponent, Angular6C2pDsParentViewchildComponent],
